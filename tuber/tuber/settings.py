...
SECRET_KEY = 'django-insecure-fc*!ealz%&z$&jd$33a80#3#(q^dl)j@cc#dsbn3o@c@@!7#h%'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'context_processors.context_processors.contactinfo',
            ],
        },
    },
]
...
STATICFILES_DIRS = [  # List of strings that contain full paths to your additional files directory
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ytuber.app@gmail.com'
EMAIL_HOST_PASSWORD = '#1Nclude'